...
Ainda assim, podemos >>desenvolver a fração algébrica:>>

$f(x) = \frac{x^3-2^3}{x-2}=\frac{(x-2)(x^2+2x+4)}{x-2} = x^2 + 2x + 4$
Dessa forma, **parece** que podermos obter um valor de $f(2)$, >>certo?>>
...
Existe, porém, uma forma de >>aproveitar essa peculiaridade...>>
