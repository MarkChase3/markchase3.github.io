...
Mas o que aconteceria, se tentássemos >>expressá-la em um plano cartesiano?>>Coordenadas De MCU Em Plano Cartesiano
...
||2d,,10  \sin(x+t),,x=0\left\\{\left\\{\sin t<0:1,0\right\\}\left\\{0>y\ge10\sin t:1,0\right\\}+\left\\{\sin t>0:1,0\right\\}\left\\{0<y<10\sin t:1,0\right\\}\ge1\right\\},,t=0||
...
Vamos então, >>calcular a velocidade instântanea no MHS.>>Velocidade e Aceleração Instântaneas
...
Agora, vamos >>analisar situações reais de ocorrência do MHS>>Sistemas Massa-Mola
