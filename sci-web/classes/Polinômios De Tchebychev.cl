...
Deve-se então provar que $T_n(x)$ pode ser >>expresso em termos polinomiais de x:>>Dedução
...
Podemos assim, >>estudar os valores de coeficientes de $T_n$>>Coeficientes
